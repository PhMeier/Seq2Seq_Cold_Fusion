...
def model_opts(parser):
    ...
    group.add('--decoder_type', '-decoder_type', type=str, default='rnn',
              choices=['rnn', 'transformer', 'cnn', 'dynamic_fusion', 'cold_fusion'], # added fusion
              help="Type of decoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|transformer|cnn].")

    group.add('--language_model', '-language_model', type=str, default="",
              help='Declare the path to language model to be loaded')
    group.add("--apply_gating_to_s_tm", "-apply_gating_to_s_tm", type=bool, default=False,
              help="Cold Fusion only: Decoder applies gating to state of TM instead of LM ")
    group.add("--use_gating_for_logit_computation", "-use_gating_for_logit_computation", type=bool, default=False,
              help="Cold Fusion only: Decoder directly uses gating to compute logits ")
